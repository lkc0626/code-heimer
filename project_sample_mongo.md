...
```sh
mongos> db.P_metadata.U.findOne({NumCommits:{$gt:300}})
{
	"_id" : ObjectId("629018a88b2efbc6e39f54ab"),
	"FileInfo" : {
		"other" : 190,
		"PHP" : 7,
		"JavaScript" : 2
	...
	"NumForks" : 0,
	"Core" : {
		"japerry <japerry@45640.no-reply.drupal.org>" : "89",
		"B_man <brendan@association.drupal.org>" : "26",
		"Ralkeon <ralkeon@gmail.com>" : "56",
		"Tyler Ward <tyler@amazee.io>" : "37",
		"drumm <drumm@delocalizedham.com>" : "67"
	}
}
mongos> 
```
